...
export enum AppActionTypes {
  ...
  APP_REVERT_INITIAL_STATE = '[App] Clear images state',
}

export const OpenModalAction = createAction(AppActionTypes.APP_OPEN_MODAL)

export const CloseModalAction = createAction(AppActionTypes.APP_CLOSE_MODAL)
...
export const RevertInitialStateAction = createAction(
  AppActionTypes.APP_REVERT_INITIAL_STATE
)
